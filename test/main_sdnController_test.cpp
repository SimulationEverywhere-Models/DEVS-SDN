...
int main(int argc, char ** argv) {
    ...
    /****** SDN Controller atomic model instantiation *******************/
    ...
    submodels_TOP = {input_reader, sdnController};
    dynamic::modeling::EICs eics_TOP;
    eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP;
    eocs_TOP = {
            dynamic::translate::make_EOC<SdnController_defs::outToSwitch,top_out_to_switch>("sdnController"),
    };
    dynamic::modeling::ICs ics_TOP;
    ics_TOP = {
            dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,SdnController_defs::inFromSwitch>("input_reader","sdnController")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/sdnController_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/sdnController_output_state.txt");
